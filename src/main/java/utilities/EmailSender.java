 ...
 * @author hodangquan
 */
public class EmailSender {private final static String emailGui = "hangochan2003@gmail.com";
    private final static String matKhau = "wpwynakqidfupsty";
...
//        while(true){
//            i++;
//            EmailSender.guiMail("hoangcongthanh090@gmail.com", "Anh ơi" +1 , "Trả fb em đi  :((" );
